...
public class GameLevel02MusicManager : MonoBehaviour
{
    ...
    private static GameLevel02MusicManager instance;
    
    public static GameLevel02MusicManager Instance
    {
        get
        {
            if (instance == null)
            {
                instance = FindFirstObjectByType<GameLevel02MusicManager>();
            }
            return instance;
        }
    }
